...
{  
	...
	{		
	   ...
	   obj.getDataFromMultiplicationHashTable("sample-text2.txt");
	   	...
	   	//to test results search for the command line entry using these objects
		...
		System.out.println(bucketstest.search(word));
		System.out.println(bucketstest2.search(word));

		System.out.println();
		HashTableImp test2 = obj.readFile("sample-text2.txt",47);
		HashTableImp2 test3 = obj.readFile2("sample-text2.txt",128);;
		
		System.out.println("sample-text1");
		System.out.println(test2.search(word));
		System.out.println(test3.search(word));
